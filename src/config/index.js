...
const  GET_SEATS_API_URL = `${BASE_API_URL}/booking/get-seats`


export { LOGIN };
export { LOGIN_API_URL, REGISTER_API_URL, LOGOUT_API_URL, GET_STATIONS_API_URL, GET_SCHEDULE_API_URL, GET_SEATS_API_URL };
